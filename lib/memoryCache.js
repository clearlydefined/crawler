...
class MemoryCache {
   ...
   * @param {import('memory-cache').CacheClass<string, unknown>} cache
   */
   ...
   * @param {string} item
   * @param {unknown} value
   * @param {((key: string, value: unknown) => void)} [afterExpire]
   ...
   * @param {unknown} value
   * @param {(key: string, value: unknown) => void} [afterExpire]
   * @param {(key: string, value: unknown) => boolean} [shouldExpire]
   */
