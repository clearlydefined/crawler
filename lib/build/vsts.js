...
class VstsBuild {
  ...
  _getCallbackCommand(requestUrl) {
    ...
    return `curl ${this.crawlerRequestUrl} -X POST -d ${JSON.stringify(
      body
    )} --header "Content-Type:application/json" --header "X-token:__CRAWLER_AUTH_TOKEN__"` // __CRAWLER_AUTH_TOKEN__ will be replaced by VSTS build
  }
