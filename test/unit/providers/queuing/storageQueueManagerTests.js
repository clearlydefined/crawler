...
describe('storageQueueManager auth selection', () => {
  let QueueServiceClient
  let DefaultAzureCredential
  let ClientSecretCredential
  let StorageQueueManager
  ...
  beforeEach(() => {
    ...
    StorageQueueManager = proxyquire('../../../../ghcrawler/providers/queuing/storageQueueManager', {
      '@azure/storage-queue': {
        QueueServiceClient,
  ...
  it('prefers managed identity over SPN and connection string', () => {
    new StorageQueueManager('UseDevelopmentStorage=true', {
